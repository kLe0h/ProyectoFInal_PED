...
namespace CapaAdministador.Controllers
{
    public class MantenedorController : Controller
    {
        ...
        public JsonResult GuardarProducto(string objeto, HttpPostedFileBase archivo)
        {
            ...
            {
                //al ser un producto nuevo
                int id_producto_generado = new CN_Producto().Registrar(oProducto, out mensaje);

                if(id_producto_generado != 0)
                {
                    oProducto.IdProducto = id_producto_generado;
                } else
                {
                ...
                if (operacion_exitosa)
                {
                    ...
                    if(archivo != null)
                    {
                        ...
                        //logica para guardar imagen en carpeta
                        try{
                            //guardando con el nombre imagen
                            archivo.SaveAs(Path.Combine(ruta_guardar, nombre_imagen));
                        ...
                        {
                            mensaje = "Hubo un error con la imagen";
                        }
